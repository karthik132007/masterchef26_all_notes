...
export const courses = [
  {
    ...
    topics: [
      ...
      { slug: "openai-api", title: "OpenAI API" },
  ...
  },
  {
    ...
    mode: "concepts",
    topics: [
      { slug: "osi", title: "OSI & TCP/IP Model" },
      { slug: "ports-and-sockets", title: "Ports & Sockets" },
      { slug: "tcp", title: "TCP: Handshake & Flow Control" },
      { slug: "dns-resolution", title: "DNS Resolution" },
      { slug: "gateway", title: "Gateway" },
      { slug: "nat", title: "NAT (Network Address Translation)" },
      { slug: "http-1-2-3", title: "HTTP/1, HTTP/2, HTTP/3" },
      { slug: "keep-alive", title: "Keep-Alive" },
      { slug: "connection-pooling", title: "Connection Pooling" },
      { slug: "rest", title: "REST APIs & HTTP Semantics" },
      { slug: "proxy", title: "Proxy (Forward vs Reverse)" },
      { slug: "ssl", title: "SSL (Secure Sockets Layer)" },
      { slug: "tls", title: "TLS & Modern Handshake" },
      { slug: "websocket", title: "WebSocket" },
      { slug: "grpc", title: "gRPC & Protocol Buffers" },
      { slug: "request-lifecycle", title: "Request Lifecycle (End-to-End)" },
    ],
  },
  {
    id: "os",
    ...
    mark: "OS",
    color: "var(--pink)",
    desc: "From absolute beginner intuition to advanced FAANG systems depth: kernel architecture, processes, scheduling, virtual memory, concurrency, epoll, and container internals.",
    mode: "concepts",
    topics: [
      { slug: "top-50-interview-questions", title: "Top 50 Interview Questions (FAANG & AI)" },
      { slug: "os-architecture-syscalls", title: "OS Architecture, Dual-Mode & Syscalls" },
      { slug: "processes-and-pcb", title: "Processes, PCB & Context Switching" },
      { slug: "threads-and-concurrency", title: "Threads, Fibers & Multithreading Models" },
      { slug: "cpu-scheduling", title: "CPU Scheduling: From FCFS to Linux CFS" },
      { slug: "synchronization-and-locks", title: "Critical Sections, Mutexes, Semaphores & Futexes" },
      { slug: "deadlocks", title: "Deadlocks: Coffman, Banker's & Real Systems" },
      { slug: "memory-management-paging", title: "Paging, Segmentation & Address Translation" },
      { slug: "virtual-memory-page-replacement", title: "Virtual Memory, Page Faults & Page Replacement" },
      { slug: "file-systems-and-storage", title: "File Systems, Inodes, VFS & Ext4 Journaling" },
      { slug: "io-management-and-epoll", title: "I/O Management, DMA, epoll, Zero-Copy & io_uring" },
      { slug: "inter-process-communication", title: "Inter-Process Communication (IPC)" },
      { slug: "virtualization-and-containers", title: "Virtualization, Linux Namespaces & Cgroups" },
      { slug: "faang-interview-playbook", title: "FAANG OS Interview Playbook & Systems Debugging" },
    ],
  },
  {
    id: "hld",
    ...
    mode: "concepts",
    topics: [
      { slug: "monolith", title: "Monolithic Architecture" },
      { slug: "load-balancer", title: "Load Balancer" },
      { slug: "api-gateway", title: "API Gateway" },
      { slug: "caching", title: "Caching & Distributed Caches" },
      { slug: "db", title: "Databases: SQL vs NoSQL, Storage Engines & Replication" },
      { slug: "sharding", title: "Database Partitioning & Sharding" },
      { slug: "microservices", title: "Microservices Architecture" },
      { slug: "messaging", title: "Message Queues & Streaming: SQS, Kafka & RabbitMQ" },
      { slug: "containerization", title: "Containerization & Docker Architecture" },
    ],
  },
  {
    id: "ml",
  ...
  },
  {
    ...
    mark: "LD",
    color: "var(--teal)",
    desc: "Object-oriented design, SOLID principles, design patterns, clean architecture, and modular coding. Turn ambiguous specs into maintainable, decoupled software.",
    mode: "concepts",
    topics: [
      { slug: "solid-overview", title: "SOLID Principles Overview" },
      { slug: "single-responsibility", title: "Single Responsibility Principle (SRP)" },
      { slug: "open-closed", title: "Open/Closed Principle (OCP)" },
      { slug: "liskov-substitution", title: "Liskov Substitution Principle (LSP)" },
      { slug: "interface-segregation", title: "Interface Segregation Principle (ISP)" },
      { slug: "dependency-inversion", title: "Dependency Inversion Principle (DIP)" },
    ],
  },
];
